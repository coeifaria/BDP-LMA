...
Sub MonitorExhibitsFile()
    ...
    If Dir(exhibitsPath) <> "" Then
        ...
        Application.OnTime Now + TimeValue("0:00:30"), "MonitorExhibitsFile"
    Else
...
Private Sub Workbook_Open()
    ...
    ' Start monitoring for exhibits.xlsx changes
    Application.OnTime Now + TimeValue("0:00:02"), "MonitorExhibitsFile"
    
    ' Set up cleanup after refresh completes
    Application.OnTime Now + TimeValue("0:00:05"), "CheckRefreshAndClean"
End Sub

' =========================================
' ADD THIS TO YOUR STANDARD MODULE (with the other functions)
' =========================================
